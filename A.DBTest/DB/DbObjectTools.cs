namespace EgoalTech.DB
{
    ...
    public class DbObjectTools
    {
        ...
        public static DynamicPropertyInfo GetDynamicPropertyInfo(Type type, PropertyInfo propertyInfo) => 
            (from info in GetDbObjectInfo(type).DynamicPropertyInfos
        ...
        {
            DynamicPropertyInfo info = (from info in dbObjectInfo.DynamicPropertyInfos
                where info.Value.PrimaryKey
                select info.Value).SingleOrDefault<DynamicPropertyInfo>();
