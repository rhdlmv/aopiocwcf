namespace A.DB
{
    ...
    public class DbOperator : IDisposable
    {
        ...
        {
            string str = "";
            if (this.type == A.DB.DbType.ORACLE)
            {
                str = "select sysdate as dt from dual";
            }
            else if ((this.type == A.DB.DbType.MSSQL) || (this.type == A.DB.DbType.VISTADB))
            {
        ...
        public A.DB.DbType DbType { get; private set; }
