...
namespace A.DB
{
    public class DbObjectOperator : IObjectOperator, IDisposable
    {
        ...
        {
            this.DbOperator = new A.DB.DbOperator(connectionString, dbProviderFactory);
        ...
        {
            return this.DbOperator.ExecuteNonQuery(sql);
        }

        public DataTable ExecuteQuery(string sql)
        {
            return this.DbOperator.QueryReturnWithDataTable(sql);
        }

        public T ExecuteScalar<T>(string sql)
        {
            return this.DbOperator.ExecuteScalar<T>(sql);
        }
        ...
        {
            A.DB.DbParameter parameter = new A.DB.DbParameter(this.DbOperator);
            T local = new T();
        ...
        {
            new A.DB.DbParameter(this.DbOperator).Write(obj);
        }
        ...
        public A.DB.DbOperator DbOperator { get; private set; }
