namespace EgoalTech.Commons.Utils
{
    ...
    public class DateTimeUtils
    {
        public static int DateTimeToUnixTimestamp(DateTime dateTime) => 
            DateTimeToUnixTimestamp(dateTime, new DateTime(0x7b2, 1, 1))
        ...
        public static DateTime GetEndOfCurrentMonth() => 
            GetEndOfMonth(GetMonthEnum(DateTime.Now.Month), DateTime.Now.Year)
        ...
        public static DateTime GetEndOfCurrentYear() => 
            GetEndOfYear(DateTime.Now.Year)

        public static DateTime GetEndOfDay(DateTime date) => 
            new DateTime(date.Year, date.Month, date.Day, 0x17, 0x3b, 0x3b, 0x3e7)
        ...
        public static DateTime GetEndOfLastYear() => 
            GetEndOfYear(DateTime.Now.Year - 1)

        public static DateTime GetEndOfMonth(Month Month, int Year) => 
            new DateTime(Year, (int) Month, DateTime.DaysInMonth(Year, (int) Month), 0x17, 0x3b, 0x3b, 0x3e7)
        ...
        public static DateTime GetEndOfYear(int Year) => 
            new DateTime(Year, 12, DateTime.DaysInMonth(Year, 12), 0x17, 0x3b, 0x3b, 0x3e7)
        ...
        public static DateTime GetStartOfCurrentMonth() => 
            GetStartOfMonth(GetMonthEnum(DateTime.Now.Month), DateTime.Now.Year)
        ...
        public static DateTime GetStartOfCurrentYear() => 
            GetStartOfYear(DateTime.Now.Year)
        ...
        public static DateTime GetStartOfLastYear() => 
            GetStartOfYear(DateTime.Now.Year - 1)

        public static DateTime GetStartOfMonth(Month Month, int Year) => 
            new DateTime(Year, (int) Month, 1, 0, 0, 0, 0)
