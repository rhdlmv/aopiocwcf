namespace EgoalTech.Commons.Utils
{
    ...
    public class EncryptUtils
    {
        ...
        public static byte[] Decrypt(byte[] encryptedData, RijndaelManaged rijndaelManaged) => 
            rijndaelManaged.CreateDecryptor().TransformFinalBlock(encryptedData, 0, encryptedData.Length)
        ...
        public static string Encrypt(string plainText, string key) => 
            Convert.ToBase64String(Encrypt(Encoding.UTF8.GetBytes(plainText), GetRijndaelManaged(key)))
